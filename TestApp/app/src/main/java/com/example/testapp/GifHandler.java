...
public class GifHandler {
    ...
    public void downloadGifToGallery(String imageUrl) {
        try {
            ...
            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_PICTURES, "GIFs/downloaded_gif.gif");
            ...
            Toast.makeText(context, "Error downloading GIF: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
